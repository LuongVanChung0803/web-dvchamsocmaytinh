...
<div class="update-form-dv">
    <div class="dv-update">
        <form action="../Frontend/thongtincanhan.php?MaKhachHang=<?php echo $MaKhachHang; ?>" method="post">
            ...
            <button type="button" class="btn-close"><a href="../thongtincanhan.php"><i class="fas fa-times"></i> EXIT</a></button>
        </form>
    </div>
</div>
